...
public class BlockOfFleshBlock extends InfecticraftModElements.ModElement {
	@ObjectHolder("infecticraft:block_of_flesh")
	public static final Block block = null;
	public BlockOfFleshBlock(InfecticraftModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_flesh");
		}
